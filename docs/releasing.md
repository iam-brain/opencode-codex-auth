...
- `.github/workflows/ci.yml`
  - runs automatically on fork pull requests and pushes to `main`; same-repository pull requests are dispatched after exact-head review with the PR branch, `pr_number`, `base_sha`, and reviewed `head_sha`
...
- `.github/workflows/secret-scan.yml`
  - runs automatically on fork pull requests and pushes to `main`; same-repository pull requests are dispatched after exact-head review with the PR branch, `pr_number`, and reviewed `head_sha`
