...
describe("upstream watch coverage", () => {
  it("tracks codex + openai auth/model/error pipeline files", () => {
    ...
    expect(tracked.has("packages/opencode/src/plugin/openai/codex.ts")).toBe(true)
    expect(tracked.has("packages/opencode/src/plugin/openai/ws.ts")).toBe(true)
    expect(tracked.has("packages/opencode/src/plugin/openai/ws-pool.ts")).toBe(true)
    ...
    expect(tracked.has("packages/core/src/models-dev.ts")).toBe(true)
    ...
    expect(tracked.has("codex-rs/login/src/auth/manager.rs")).toBe(true)
    expect(tracked.has("codex-rs/login/src/server.rs")).toBe(true)
    expect(tracked.has("codex-rs/core/src/client.rs")).toBe(true)
    expect(tracked.has("codex-rs/core/src/session/multi_agents.rs")).toBe(true)
    expect(tracked.has("codex-rs/core/src/codex_thread.rs")).toBe(true)
    expect(tracked.has("codex-rs/core/src/codex_delegate.rs")).toBe(true)
